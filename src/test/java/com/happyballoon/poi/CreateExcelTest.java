...
public class CreateExcelTest {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //使用hssfWorkbook创建HSSFSheet对象，对应hssfWorkbook文件中的一页
        ...
        //调用工具函数生成excel文件
        FileOutputStream outputStream = new FileOutputStream("E:\\JavaProjects\\studentList.xls");//目录必须手动创建,文件如果不存在，poi会自动创建
